...
def button_function():
    ...
    button_sumbit.place(x=380, y=560)
 ...
 #________________________________________       
    ...
    button_jouer.place(x=225, y=605)
    ...
    button_music= CTk.CTkButton(master=frame2, text="music", font=("Century Gothic",16), command=play_music)
    button_music.place(x=70, y=560)

    button_stats= CTk.CTkButton(master=frame2, text="Stats", font=("Century Gothic",16))
    button_stats.place(x=225, y=560)
